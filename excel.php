		...
		<div class="container">
			...
			<div id="navbar" class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					...
					<li><a href="#">Выгрузка в Excel</a></li>
					<li class="active"><a href="/routes/excel.php">Выгрузка в Excel (вар.2)</a></li>
				</ul>
			</div><!--/.nav-collapse -->
		</div>
	</nav>
		...
		<div class="row">
			<div class="panel panel-primary" >
				...
				<div class="panel-body" align="center">
					<form action="/routes/stops4.php" method="GET">
					...
					<br><br>
<!--					<label id="radlbl">Радиус поиска остановок: 250 метров</label><input name="radius" id="range" type="range" min="0" max="2000" id="radius" oninput="updateLabel(this.value)" value="250" step="50"><br>
					<label>Фильтр рейсов:</label>
						<select id="trip_filter" name="filter" class="js-triptypes-ajax" style="width: 10%">
						</select>&nbsp;
						<input type="checkbox" name="surround" value="true" checked>Выводить остановки в радиусе<br>-->
					</form>
